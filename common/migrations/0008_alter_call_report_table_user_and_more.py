...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0007_alter_call_report_table_workername'),
    ...
    operations = [
        migrations.AlterField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='call_report_table_profile_User', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='call_report_table',
            name='workerName',
